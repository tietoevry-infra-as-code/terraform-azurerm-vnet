...
resource "azurerm_network_security_group" "nsg" {
  ...
  dynamic "security_rule" {
    ...
    content {
      ...
      source_port_range          = "*"
      destination_port_range     = security_rule.value[5] == "" ? "*" : security_rule.value[4]
      ...
      description                = security_rule.value[8] == "" ? "port_${security_rule.value[5]}" : security_rule.value[8]
    }
  }
}
